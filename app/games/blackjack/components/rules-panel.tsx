...
import { HOUSE_RULE_LABELS, MAX_SPLITS_CAP } from "../lib/houseRules"
...
export default function RulesPanel({ rules, seatCount, onRulesChange, onSeatCountChange }: Props) {
  const set = <K extends keyof HouseRules>(key: K, value: HouseRules[K]) =>
    onRulesChange({ ...rules, [key]: value })

  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 w-full max-w-md text-sm">
